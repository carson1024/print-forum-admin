      ...
      <div className="space-y-6 p-4 sm:p-6">
            ...
            <div className='p-5 bg-gray-50 rounded-[22px] space-y-5'>
              ...
              <div className='space-y-3'>
                <div className='flex items-center flex-wrap gap-2'>
                  ...
                  <button className='ml-auto text-primary text-xs font-normal hover:text-primary/80' onClick={() => setIsAllCopiersModalOpen(true)}>View All</button>
                </div>
                <div className='flex flex-wrap gap-4'>
                  <div className="flex items-center gap-1">
        ...
        <div className="">
          <div className='flex items-center justify-between mt-10 mb-5'>
            <h3 className="text-base sm:text-md font-bold">Trades</h3>
            <div className="btn-group light">
              <button className="btn btn-sm text-sm sm:text-base active">Active</button>
              <button className="btn btn-sm text-sm sm:text-base">Past</button>
            </div>
          </div>
          <div className="flex flex-col gap-2">
            {
              Array(2).fill(0).map((value, index) => <div className="bg-gray-50 rounded text-sm px-4 py-3 flex items-center gap-3 sm:gap-5 flex-wrap">
                <div className="min-w-[40px]">
                  {
                    index % 2 == 0 ?
                      <button className="rounded-full bg-green-600 text-black btn-xs">Buy</button>
                    :
                      <button className="rounded-full bg-red-400 text-white btn-xs">Sell</button>
                  }
                </div>
                ...
                <div className='grid grid-cols-4 gap-2 mr-auto'>
                  <div className="space-y-1">
